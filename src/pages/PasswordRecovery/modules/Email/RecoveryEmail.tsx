...
import {MailRecoveryForm, mailRecoveryFormSchema} from "./RecoveryEmail.schema";
import {yupResolver} from "@hookform/resolvers/yup";
import {useRecoveryContext} from "../../PasswordRecovery.context";
import '../../PasswordRecovery.css'
import '../../../../main.css'
import {ErrorResponse} from "../../../../api/createRequest";
import {sendEmail} from "../../../../api/v0/account/account.requests";
...
const RecoveryEmail: React.FC = ( ) => {
    ...
    const handleEmailRecovery = async (data : MailRecoveryForm) => {
        try {
    ...
    const {
        ...
        control,
        formState: { errors },
        reset } = useForm<MailRecoveryForm>({
        resolver: yupResolver(mailRecoveryFormSchema),
        mode: 'onBlur',
    });
